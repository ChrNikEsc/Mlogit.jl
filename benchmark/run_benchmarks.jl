...
BenchmarkTools.save("benchmark/results_"*Dates.format(Dates.now(), "yyyy-mm-dd-HH-MM-SS") * "_" * string(median(results_lclogit_grad).allocs) * ".json", median(results_lclogit_grad))
