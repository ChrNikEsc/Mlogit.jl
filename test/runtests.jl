...
@testset "Mlogit.jl" begin
    ...
    @test round(sum(model_lclogit_em.loglikelihood), digits=-1) ∈ [-1070.0, -1080.0, -1090.0]
    ...
    @test round(sum(model_lclogit_grad.loglikelihood), digits=-1) ∈ [-1070.0, -1080.0, -1090.0]
end
